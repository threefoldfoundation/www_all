...
2. Then, you will need to exchange your deposited fiat or cryptocurrency into either BTC (Bitcoin) or USDT (Tether)
    - These are currently the only trading pairs available with [TFT](threefold__threefold_token)
...
3. Now you can start buying [TFT](threefold__threefold_token)
...
Liquid also has a [Quick Exchange](https://app.liquid.com/quick-exchange/), which will allow you to instantly buy [TFT](threefold__threefold_token) with a Visa card. For purchases of $150 USD or less, no KYC is required.