...
BTC-Alpha was the first cryptocurrency exchange to support [TFT](threefold__threefold_token)s (TFT).
...
![Registration](threefold__btc_alpha_registration.png  )
...
![LogIn](threefold__btc_alpha_login.png  )
