...
![alt_text](tftech__smartcontract4it.png  )
...
*   Information technology architectures are configured and installed by bots (a 'smart contract agent'), not people;
...
A system that enforces these two principles if the ThreeFold Technology stack. It works as follows:

## Steps

![alt_text](tftech__smart_contract_it.png  )
