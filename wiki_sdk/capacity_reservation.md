...
- **CustomerTid**: The [3Bot](threefold__3bot_def) id of the customer creating this reservation,
this will also become the owner of the pool. Only the owner of this [3Bot](threefold__3bot_def)
