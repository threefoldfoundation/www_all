...
> **ERROR: link, cannot find page: corex---the-0-os-container-process-manager.
IError(Error{
    msg: 'cannot find the file: corex---the-0-os-container-process-manager'
    code: 0
}) **<BR>
...
* `network_connection`: This is where you define the network of the container
 ...
 - `network_id`: The name of the network created using a [network](sdk__network.md)
 primitive.
...
More information about Flist at [Flist documentation](sdk__architecture_flist.md).
