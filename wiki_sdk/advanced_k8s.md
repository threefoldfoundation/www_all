...
> **ERROR: link, cannot find file: ressources/ha/k3s-ha-architecture.svg.
IError(Error{
    msg: 'cannot find the file: ressources/ha/k3s-ha-architecture.svg'
    code: 0
}) **<BR>
