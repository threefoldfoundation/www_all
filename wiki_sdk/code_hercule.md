...
Please check a full installation tutorial [here](cloud__minio.md)

# Diagrams
![Minio Arch](sdk__minio_arch.png  )

## Master/Slave setup
![Minio Master/Slave](sdk__minio_master_slave.png  )
...
## Graphical
Please refer to the [tutorial](sdk__tutorials.md) for a full walk through to deploy a fully working minio with master/slave setup and monitoring enabled.
