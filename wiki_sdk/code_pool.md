...
To be able to deploy workloads on the TF Grid, a user first needs to have reserved some IT capacity from a farmer. To do so, a user can create a pool of capacity which contains a certain amount of [cloud units](threefold__cloud_units.md). 
...
Further details about capacity pool is available at: [Capacity pool](sdk__capacity_pool.md).
