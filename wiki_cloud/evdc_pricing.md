...
A eVDC comes in different shapes. The price of the monthly subscription fees is expressed here in EUR. The equivalent amount in [TFT](threefold__threefold_token) at a [TFT](threefold__threefold_token) price of 0.10 USD will be billed.
...
All info on how to buy [TFT](threefold__threefold_token) can be found [here](threefold__how_to_buy_and_sell.md)