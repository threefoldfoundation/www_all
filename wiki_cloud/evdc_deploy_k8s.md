...
- This deployment creates the K3S Lightweight Kubernetes implementation in [Zero-OS](threefold__zos)
...
- Both K8S and storage have their own flow – actions in order to deploy your own instance on top of the [ThreeFold Grid](threefold__threefold_grid).
